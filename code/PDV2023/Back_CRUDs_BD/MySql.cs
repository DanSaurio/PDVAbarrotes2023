...
namespace Back_CRUDs_BD
{
	public class MySql:CRUDs_BD
	{
        ...
        public override bool borrarusuario(string tabla, int id)
        {
            //DELETE FROM tabla WHERE id=90;
            bool resultado = false;
            try
        ...
        public override bool insertarusuario(string tabla, List<string> campos, List<ValoresAInsertar> valores)
        {
            //definir var de resultado
            bool resultado = false;
            //programar el ESQUELETO de ejecutar una ACCION de QUERY en BD
        ...
        public override bool modificarusuario(string tabla, List<string> campos, List<ValoresAInsertar> valores, int id)
        {
            bool resultado = false;
            try
            {
